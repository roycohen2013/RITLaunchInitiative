...
float adcVoltStepToCelcius(int voltSteps) {
	// resistance = ((10k)(ADC))/(4096-ADC)
	float resistance = (10000)*(voltSteps)/(4096-voltSteps);
	float degreesCelcius = (-23.03*log(resistance))+296.3;
